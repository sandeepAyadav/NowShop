...
//        right-0 bottom-[5%] '>
//         <form  action=""  className='w-[100%] md:w-[90%] h-[100%]  mt-[70px] flex flex-col gap-[30px]
//          py-[90px] px-[30px] md:px-[60px]'>
        ...
        >
            ...
            <div className="w-[100%] h-[100%] flex items-center justify-start ">
              <label htmlFor="image1"
                ...
                <img src={!image1 ? upload : URL.createObjectURL(image1)}
                  alt="" className="w-[80%] h-[80%] rounded-lg shadow-2xl hover:border-[#1d1d1d] border-[2px]"/>
                <input type="file" id="image1" hidden onChange={e => setImage1(e.target.files[0])} required/>
              </label>
              <label
                htmlFor="image2"
                ...
                <img src={!image2 ? upload : URL.createObjectURL(image2)}
                  alt=""   className="w-[80%] h-[80%] rounded-lg shadow-2xl hover:border-[#1d1d1d] border-[2px]"/>
                <input
                  type="file" id="image2" hidden onChange={e => setImage2(e.target.files[0])}
                  required />
              </label>
              ...
              <label htmlFor="image4" className=" w-[65px] h-[65px] md:w-[100px] md:h-[100px] cursor-pointer hover:border-[#46d1f7]">
                <img src={!image4 ? upload : URL.createObjectURL(image4)} alt=""  className="w-[80%] h-[80%] rounded-lg shadow-2xl hover:border-[#1d1d1d] border-[2px]" />
                <input
                  type="file" id="image4" hidden onChange={e => setImage4(e.target.files[0])}required/>
              </label>
            </div>
          </div>
          ...
          <div className="w-[80%] h-[100px] flex items-start justify-center flex-col  gap-[10px]">
            ...
            <input
              ...
              className="w-[600px] max-w-[98%] h-[40px] rounded-lg hover:border-[#46d1f7] border-[2px] cursor-pointer bg-slate-600 px-[20px] text-[18px] placeholder:text-[#ffffffc2]"
              onChange={e => setPrice(e.target.value)}value={price} require />
          </div>
